...
class Player {
    ...
    initPlayerListeners(){
        ...
        this.player.querySelector('.speed__change-button--speed-down').addEventListener('click', this.changeSpeedDown.bind(this))
        this.player.querySelector('.speed__change-button--speed-up').addEventListener('click', this.changeSpeedUp.bind(this))
    }
...
changeSpeedDown(){
    let speedDown = document.querySelector('.speed__change-button--speed-down')
    if (window.target = speedDown) {
...
changeSpeedUp(){
    let speedUp = document.querySelector('.speed__change-button--speed-up')
    if (window.target = speedUp) {
        this.video.playbackRate += 0.25
    }
    console.log(this.video.playbackRate);
}
